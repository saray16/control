                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.users.update', $user->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nombre" id="nombre" value="{{ old('nombre', $user->nombre) }}" class="form-control shadow-sm @error('nombre') is-invalid @enderror" required>
                            @error('nombre')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" name="email" id="email" value="{{ old('email', $user->email) }}" class="form-control shadow-sm @error('email') is-invalid @enderror" required>
                            @error('email')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
