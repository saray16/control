...
<head>
    <meta charset="UTF-8">
    <title>Certificado de Diplomado</title>
    <style>
...
<body>
    <div class="certificate-container">
        ...
        <div class="content">
            <p class="declaration">
                Se otorga el presente certificado a la persona abajo indicada por haber completado satisfactoriamente
                todos los módulos y evaluaciones correspondientes al diplomado profesional dictado en nuestra institución.
            </p>
            
            <div class="recipient-name">{{ $inscripcion->user->name }}</div>
            
            <div class="program-name">{{ $inscripcion->diplomado }}</div>
            ...
            <div class="signatures">
                <div class="signature">
                    ...
                    <div class="signature-title">Facilitador del Diplomado</div>
                </div>
                <div class="signature">
                    <div class="signature-line"></div>
        ...
        <div class="certificate-id">
            ID: {{ strtoupper($codigo_verificacion) }}
        </div>
    </div>
</body>
</html>